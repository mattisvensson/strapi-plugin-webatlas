...
export default function RouteItemStatus({
	...
	if (item.clientModifications?.type === 'create')
		return (
			<Badge backgroundColor="success100" textColor="success600" borderColor="success200">
	...
	if (item.clientModifications?.type === 'update' || isUpdated)
		return (
			<Badge backgroundColor="warning100" textColor="warning600" borderColor="warning200">
				<Typography fontWeight="bold">
					{formatMessage({
	...
	if (item.clientModifications?.type === 'delete')
		return (
			<Badge backgroundColor="danger100" textColor="danger600" borderColor="danger200">
				<Typography fontWeight="bold">
					{formatMessage({
