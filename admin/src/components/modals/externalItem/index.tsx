...
function isExternalEditProps(props: externalItemProps): props is externalEditProps {
	return props.variant === 'ExternalEdit'
}
function isExternalCreateProps(props: externalItemProps): props is externalCreateProps {
