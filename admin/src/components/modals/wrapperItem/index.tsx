...
function isWrapperEditProps(props: wrapperItemProps): props is wrapperEditProps {
	return props.variant === 'WrapperEdit'
}
function isWrapperCreateProps(props: wrapperItemProps): props is wrapperCreateProps {
